...
while((positionVal1 <=31)  || (positionVal1 >=38))
{
read_sensor_values1();
if(positionVal1 >38)
{
...
read_sensor_values3();
while((positionVal3 <=37)  || (positionVal3 >=43))
{
read_sensor_values3();
if(positionVal3 >43)
{
...
read_sensor_values1();
while((positionVal1 <=37)  || (positionVal1 >=43))
{
read_sensor_values1();
if(positionVal1 >43)
{
